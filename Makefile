all :
	pandoc -f markdown_github -t html5 -o Resume.html -s --self-contained Resume.md
	...
	pandoc -f markdown_github -o Resume.pdf -s -V papersize:"letterpaper" --css ResumeStyle.css  Resume.md
